        ...
        public List<Post> GetAllPost(List<PostWithCategory> list, int? loginId)
        {
            ...
            if (list != null)
            {
                foreach (var item in list)
                {
                    ...
                    {
                        case 1:
                            string NGOUser = NGOUserlist.Where(ngusr => ngusr.LoginID == item.LoginID).FirstOrDefault().NGOName.ToString();
                            pm.userName = NGOUser;
                            break;
                        case 3:
                            var RegUser = RegUserlist.Where(lgnuser => lgnuser.LoginID == item.LoginID).FirstOrDefault();
                    ...
                    foreach (var like in PostLikeList)
                    {
                        ...
                        {
                            case 1:
                                string NGOUser = NGOUserlist.Where(ngusr => ngusr.LoginID == like.LoginID).FirstOrDefault().NGOName.ToString();
                                pl.userName = NGOUser;
                                break;
                            case 3:
                                var RegUser = RegUserlist.Where(lgnuser => lgnuser.LoginID == like.LoginID).FirstOrDefault();
                    ...
                    foreach (var a in postcomment)
                    {
                        ...
                        {
                            case 1:
                                string NGOUser = NGOUserlist.Where(ngusr => ngusr.LoginID == a.LoginID).FirstOrDefault().NGOName.ToString();
                                cmnt.Username = NGOUser;
                                break;
                            case 3:
                                var RegUser = RegUserlist.Where(lgnuser => lgnuser.LoginID == a.LoginID).FirstOrDefault();
                    ...
                    pm.donateItemlist = obj.donationdetails(item.RequestID, loginId);
                    ob.Add(pm);
